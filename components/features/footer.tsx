...
const navigation = {
  ...
  social: [
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/onixstormshield?igsh=OHdnaXM1OWliZjRu",
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          <div className="space-y-8">
            <div className="flex flex-col items-start space-y-4">
              <img alt="ONIX STORMSHIELD" src="/logo.svg" className="h-16 w-auto" />
              <div className="text-left">
                <h2 className="text-2xl font-bold text-white mb-2">ONIX STORMSHIELD</h2>
            ...
            <div className="border-l-2 border-white/20 pl-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {navigation.solutions.map((item) => (
                  ...
                  >
                    <div className="w-2 h-2 bg-blue-400 rounded-full group-hover:bg-white transition-colors duration-300"></div>
